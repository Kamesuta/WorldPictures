...
public class GuiCCButton extends GuiWidget {
	...
	public void drawButtonTex(int mousex, int mousey) {
		...
		drawTexturedModalRect(x, y + height / 2, 0, 46 + state * 20 + 20 - height / 2, width / 2, height / 2);// bottom
																												// left
		drawTexturedModalRect(x + width / 2, y + height / 2, 200 - width / 2, 46 + state * 20 + 20 - height / 2,
				width / 2, height / 2);// bottom right

//		drawTexturedModalRect(x, y, 0, 46 + state * 20, this.width / 2, this.height);
//
//		drawTexturedModalRect(x + this.width / 2, y, 200 - this.width / 2, 46 + state * 20, this.width / 2, this.height);
	}
